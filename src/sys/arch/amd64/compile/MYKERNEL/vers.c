...
const char osrelease[] = "7.1.2";
const char sccs[] = "@(#)" "NetBSD 7.1.2 (MYKERNEL) #2: Wed May  9 14:24:13 EET 2018\n"
"	root@MDesouky.my.domain:/usr/src/sys/arch/amd64/compile/MYKERNEL\n";
const char version[] = "NetBSD 7.1.2 (MYKERNEL) #2: Wed May  9 14:24:13 EET 2018\n"
"	root@MDesouky.my.domain:/usr/src/sys/arch/amd64/compile/MYKERNEL\n";
